const getIDbyLanguageName = (lang) => {
  ...
  return language ? language.id : null; // returns null if not found
};

// Example usage:
console.log(getIDbyLanguageName("Python (3.8.1)")); // Output: 71
console.log(getIDbyLanguageName("C++ (GCC 9.2.0)")); // Output: 54
